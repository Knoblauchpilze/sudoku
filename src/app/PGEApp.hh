...
namespace pge {
  ...
  class PGEApp: public utils::CoreObject, public olc::PixelGameEngine {
    ...
    protected:
      ...
      /**
       * @brief - Whether or not the rendering represents the
       *          first frame drawn ever. Allows to display a
       *          log only once for example.
      ...
      /**
       * @brief - Returns `true` in case the debug layer has
       *          been activated.
      ...
      /**
       * @brief - Returns `true` in case the UI layer has been
       *          activated.
       ...
       *          needed for the data displayed by this app.
